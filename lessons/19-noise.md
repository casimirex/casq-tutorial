# Lesson 19 — Noise & the NISQ reality

**Example:** [`examples/19_noise.rs`](../examples/19_noise.rs) ·
`cargo run --example 19_noise`
...
3. Connect this back to Lesson 14/17: *why* are shallow variational circuits the
...
error-tolerant designs until full error correction (Lesson 18) matures.

Next: [Lesson 20 — BB84 quantum key distribution](20-bb84.md)
