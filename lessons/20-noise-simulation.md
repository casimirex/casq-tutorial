...
**Example:** [`examples/20_noise_simulation.rs`](../examples/20_noise_simulation.rs) ·
`cargo run --example 20_noise_simulation`

## The idea

Lesson 18 introduced noise *channels* as a catalog. This lesson **runs** circuits
