...
**Example:** [`examples/17_error_correction.rs`](../examples/17_error_correction.rs) ·
`cargo run --example 17_error_correction`
...
Next: [Lesson 18 — Noise & the NISQ reality](18-noise.md)
