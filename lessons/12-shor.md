# Lesson 12 — Shor's algorithm

**Example:** [`examples/12_shor.rs`](../examples/12_shor.rs) ·
`cargo run --example 12_shor`
...
Next: [Lesson 13 — Quantum teleportation](13-teleportation.md)
