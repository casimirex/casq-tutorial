# Lesson 16 — Quantum machine learning

**Example:** [`examples/16_quantum_ml.rs`](../examples/16_quantum_ml.rs) ·
`cargo run --example 16_quantum_ml`
...
The same variational loop from Lesson 13 — a parameterized **ansatz** circuit
...
differs from the per-qubit Pauli terms in Lesson 13's algorithms API.
...
Next: [Lesson 17 — Quantum error correction](17-error-correction.md)
