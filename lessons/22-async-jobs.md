...
**Example:** [`examples/22_async_jobs.rs`](../examples/22_async_jobs.rs) ·
`cargo run --example 22_async_jobs`
...
background — optionally on a chosen **backend** (Lesson 21). You then **poll** the
...
backends (Lesson 21), you can now dispatch a circuit to any target and collect
