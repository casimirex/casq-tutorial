# Lesson 6 — Multi-qubit gates: CNOT, CZ, SWAP, Toffoli, Fredkin

**Example:** [`examples/06_multi_qubit_gates.rs`](../examples/06_multi_qubit_gates.rs) ·
`cargo run --example 06_multi_qubit_gates`
...
(the routing problem of Lesson 24). It's three CNOTs in a trench coat.
...
Next: [Lesson 7 — Engines & scaling](07-engines.md) · or back to the
[overview](../README.md).
