# Lesson 8 — Deutsch–Jozsa

**Example:** [`examples/08_deutsch_jozsa.rs`](../examples/08_deutsch_jozsa.rs) ·
`cargo run --example 08_deutsch_jozsa`
...
Next: [Lesson 9 — Grover's search](09-grover.md)
